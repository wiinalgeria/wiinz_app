...
final Map<String, String> _fr = {
  ...
  'السنة': 'Année',
  'الجنس': 'Sexe',
  'الجنس (اختياري)': 'Sexe (facultatif)',
  'يمكنك ترك هذا الحقل فارغاً': 'Vous pouvez laisser ce champ vide',
  'ذكر': 'Homme',
  'أنثى': 'Femme',
  ...
  'سيتم حذف حسابك ونقاطك وسجلك نهائياً. لا يمكن التراجع عن هذا الإجراء ولا استرجاع نقاطك.':
      'Votre compte, vos points et votre historique seront définitivement supprimés. Cette action est irréversible et vos points ne pourront pas être récupérés.',
  'متابعة': 'Continuer',
  'تأكيد الحذف': 'Confirmer la suppression',
  'أدخل كلمة المرور لتأكيد حذف حسابك.': 'Saisissez votre mot de passe pour confirmer la suppression de votre compte.',
  'حذف حسابي نهائياً': 'Supprimer définitivement',
  'جارٍ الحذف...': 'Suppression...',
...
final Map<String, String> _en = {
  ...
  'يمكنك ترك هذا الحقل فارغاً': 'You can leave this field empty',
  ...
  'سيتم حذف حسابك ونقاطك وسجلك نهائياً. لا يمكن التراجع عن هذا الإجراء ولا استرجاع نقاطك.':
      'Your account, points and history will be permanently deleted. This cannot be undone and your points cannot be restored.',
  'متابعة': 'Continue',
  'تأكيد الحذف': 'Confirm deletion',
  'أدخل كلمة المرور لتأكيد حذف حسابك.': 'Enter your password to confirm deleting your account.',
  'حذف حسابي نهائياً': 'Permanently delete',
  'جارٍ الحذف...': 'Deleting...',
