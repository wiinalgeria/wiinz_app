      ...
      child: Column(children: [
        ...
        if (region.isNotEmpty) ...[
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Text(region, style: body(13.5, color: const Color(0xFFCFF3E0))),
          ]),
        ],
        ...
        if (joined != null) ...[
          ...
          Text(trf('انضم {t}', {'t': timeAgo(joined)}), style: body(12.5, color: Colors.white.withValues(alpha: 0.6))),
        ],
      ]),
    );
  }
  ...
  Widget _statsRow() {
    Widget cell(String v, String label, String icon, Color color) => Expanded(child: Container(
      ...
      child: Column(children: [
        ...
        Text(tr(label), style: body(12, color: C.textSecondary), textAlign: TextAlign.center),
      ]),
    ));
    return Row(children: [
  ...
  Widget _badge(String icon, String title, String desc, bool unlocked) {
    return Container(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        const SizedBox(height: 2),
        Text(tr(desc), style: body(11.5, color: C.textTertiary), textAlign: TextAlign.center, maxLines: 2, overflow: TextOverflow.ellipsis),
      ]),
    );
  }
}
