...
class _HomeScreenState extends ConsumerState<HomeScreen> {
        ...
        child: AlertDialog(
          ...
          content: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(tr('الإشعارات معطّلة. فعّلها لتصلك التنبيهات عن الهدايا والنقاط الجديدة حتى وأنت خارج التطبيق.'),
                textAlign: TextAlign.center, style: body(14.5, color: C.textSecondary, height: 1.6)),
          ]),
          actions: [
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Padding(padding: const EdgeInsets.symmetric(horizontal: 8),
                          child: Text(tr(s.$2), textAlign: TextAlign.center, style: body(14.5, color: C.textSecondary, height: 1.6))),
                      ]);
                    },
                  ),
                ),
                  ...
                  children: [
                    ...
                    Center(child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Flexible(child: Text(
                        ...
                        style: body(12.5, color: C.textTertiary), overflow: TextOverflow.ellipsis)),
                    ])),
                    const SizedBox(height: 14),
                    // primary scan
                    Pressable(
      ...
      child: Column(
        ...
        children: [
          ...
          Align(alignment: Alignment.centerLeft, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('AVAILABLE BALANCE', style: cairo(11, w: FontWeight.w600, color: Colors.white.withValues(alpha: 0.7), spacing: 2)),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.end, children: [
            Flexible(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
              ...
              Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text(user.commune, style: body(13.5, color: Colors.white.withValues(alpha: 0.9))),
              ]),
            ])),
            Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
              Text('CARD / INVITE', style: cairo(11, w: FontWeight.w600, color: Colors.white.withValues(alpha: 0.7), spacing: 1)),
  ...
  Widget _cardBack(WiinzUser user) {
    ...
    Widget qr(String data, String label, String caption) => Column(mainAxisSize: MainAxisSize.min, children: [
      ...
      Text(label, style: cairo(11, w: FontWeight.w800, color: Colors.white)),
      Text(caption, style: body(11.5, color: Colors.white.withValues(alpha: 0.6)), textDirection: TextDirection.ltr),
    ]);
      ...
      child: hp == null
        ? Row(children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.end, mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              const SizedBox(height: 14),
              Text(tr('اعرض هذا الرمز لموظف نقطة الجمع ليضيف نقاطك'), style: body(12.5, color: Colors.white.withValues(alpha: 0.55), height: 1.5), textAlign: TextAlign.start),
            ])),
          ])
      ...
      child: Container(
        ...
        child: Stack(children: [
          ...
          Positioned(top: 8, right: 12, child: Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2), decoration: BoxDecoration(color: Colors.black.withValues(alpha: 0.22), borderRadius: BorderRadius.circular(6)),
            child: Text(tr('إعلان'), style: body(11.5, w: FontWeight.w600, color: Colors.white)))),
          Padding(padding: const EdgeInsets.symmetric(horizontal: 20), child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(sub, style: body(13.5, color: Colors.white.withValues(alpha: 0.85)), maxLines: 1, overflow: TextOverflow.ellipsis),
            if (hasCta) ...[
              const SizedBox(height: 10),
              Container(
      ...
      Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          if (s.subtitle.isNotEmpty) ...[
            const SizedBox(height: 8),
            Text(s.subtitle, textAlign: TextAlign.center, maxLines: 2, overflow: TextOverflow.ellipsis, style: body(14.5, color: C.textSecondary, height: 1.6)),
          ],
          if (hasCta) ...[
            const SizedBox(height: 16),
            Pressable(
