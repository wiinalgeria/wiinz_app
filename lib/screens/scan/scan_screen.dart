                  ...
                  Container(color: const Color(0xFF0C0F0C), child: Center(child: Padding(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      Text(tr('يحتاج التطبيق إلى إذن الكاميرا لمسح الرموز'),
                        textAlign: TextAlign.center, style: body(14, color: Colors.white.withValues(alpha: 0.85))),
                      const SizedBox(height: 16),
                      Pressable(
                ...
                SafeArea(
                  ...
                  child: Column(children: [
                    ...
                    Padding(padding: const EdgeInsets.fromLTRB(40, 0, 40, 24),
                      child: Text(tr('وجّه الكاميرا نحو رمز QR الموجود على نقطة الجمع'), textAlign: TextAlign.center, style: body(14, color: Colors.white.withValues(alpha: 0.85)))),
                  ]),
                ),
              ],
            ),
