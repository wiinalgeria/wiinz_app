...
Widget _audienceChip(AppNotification n) {
  ...
  return Container(
    ...
    child: Row(mainAxisSize: MainAxisSize.min, children: [
      ...
      Text(targeted ? tr('رسالة موجّهة إليك') : tr('إشعار عام'), style: cairo(11, w: FontWeight.w800, color: fg)),
    ]),
  );
}
      ...
      child: ConstrainedBox(
        ...
        child: SingleChildScrollView(child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(n.whenLabel, style: body(12.5, color: C.textTertiary)),
          ...
          : ListView(
              ...
              children: [
                ...
                if (items.isEmpty && !tempPw)
                  Padding(padding: const EdgeInsets.all(24), child: Center(child: Text(tr('لا توجد إشعارات'), style: body(14, color: C.textTertiary))))
                else
                  ...items.map(_row),
              ],
            ),
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(tr('تم تعيين كلمة مرور مؤقتة لحسابك. غيّرها الآن.'), style: body(13, color: C.textSecondary)),
        ])),
      ]),
      const SizedBox(height: 10),
      Pressable(
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if (n.body.isNotEmpty)
            Text(n.body, style: body(13, color: C.textSecondary), maxLines: 2, overflow: TextOverflow.ellipsis),
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
          Text(n.whenLabel, style: body(12, color: C.textTertiary)),
          const SizedBox(height: 8),
                      ...
                      SizedBox(width: 88, height: 88, child: Stack(alignment: Alignment.center, children: [
                        ...
                        Container(width: 70, height: 70, decoration: const BoxDecoration(color: C.forest, shape: BoxShape.circle),
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Text('Wz', style: cairo(11, w: FontWeight.w700, color: Colors.white.withValues(alpha: 0.6))),
                          ])),
                      ])),
...
Text(trf('لوحة الصدارة · {zone}', {'zone': placeName('$zone')}), style: cairo(15, w: FontWeight.w800, color: C.forest))]),
                ...
                const SizedBox(height: 8),
                if (history.isEmpty) Padding(padding: const EdgeInsets.all(16), child: Center(child: Text(tr('لا توجد حركات بعد'), style: body(14, color: C.textTertiary))))
  ...
  Widget _quick(String v, String l, Color color) => Expanded(child: Container(
    padding: const EdgeInsets.all(14),
    decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(16), border: Border.all(color: C.cardBorder)),
    child: Column(children: [Text(v, style: cairo(22, w: FontWeight.w900, color: color)), const SizedBox(height: 2), Text(tr(l), style: body(12, color: C.textSecondary), textAlign: TextAlign.center)]),
  ));
          ...
          if (l.prize.isNotEmpty) ...[
            ...
            Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text(l.prize, style: cairo(11, w: FontWeight.w800, color: C.goldText)),
              ])),
          ],
        ])),
        const SizedBox(width: 8),
  ...
  Widget _pointsBoardBody() {
    ...
    if (_pointsBoard.isEmpty) {
      return Padding(padding: const EdgeInsets.all(24), child: Center(child: Text(tr('لا توجد بيانات بعد'), style: body(14, color: C.textTertiary))));
    }
    const medals = [Color(0xFFC9A227), Color(0xFFAEB7C2), Color(0xFFB08D57)];
        ...
        return Container(
          ...
          child: Row(children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text(trf('{d} إيداع · {u} مستخدم', {'d': '${r['deposits'] ?? 0}', 'u': '${r['users'] ?? 0}'}), style: body(12, color: C.textTertiary)),
            ])),
            Row(children: [
