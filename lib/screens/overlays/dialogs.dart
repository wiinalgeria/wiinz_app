      ...
      builder: (context, setLocal) {
        ...
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(pointName, style: body(14, color: C.textSecondary)),
            ...
            if (atMax) ...[
              ...
              Text(trf('الحد الأقصى {n} قارورة في الإيداع الواحد', {'n': '$maxBottles'}),
                textAlign: TextAlign.center, style: body(13, color: C.goldText)),
            ],
            const SizedBox(height: 22),
            Row(children: [
              Expanded(child: Pressable(
        ...
        child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(done ? tr('انتهى وقت الانتظار، يمكنك مسح رمز QR وإيداع قارورات جديدة')
              ...
              style: body(14.5, color: C.textSecondary, height: 1.5), textAlign: TextAlign.center),
            if (!done) ...[
...
Future<void> showScanIntro(BuildContext context) {
  ...
  Widget step(int n, String icon, String title) => Padding(
    ...
    child: Row(children: [
      ...
      Expanded(child: Text(tr(title), style: body(14.5, color: C.textSecondary, height: 1.45))),
      const SizedBox(width: 8),
    ...
    builder: (_) => Directionality(textDirection: appDirection, child: Dialog(
      ...
      child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text.rich(TextSpan(text: tr('رصيدك الآن '), style: body(14, color: const Color(0xFF6B6459)), children: [
      ...
      child: SingleChildScrollView(child: Column(mainAxisSize: MainAxisSize.min, children: [
        Container(
          ...
          child: Column(children: [
            ...
            const SizedBox(height: 4),
            Text(tr(title), style: body(14, color: Colors.white.withValues(alpha: 0.7))),
          ]),
        ),
        Padding(
          ...
          child: Column(children: [
            ...
            Container(
              ...
              child: Column(children: [
                Text('CODE', style: body(11.5, color: C.textSecondary, w: FontWeight.w600)),
                ...
                child: Column(children: [
                  Row(children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      if (store.address.isNotEmpty) Row(children: [mi('location_on', size: 13, color: C.textTertiary), const SizedBox(width: 3), Expanded(child: Text(store.address, style: body(12.5, color: C.textSecondary), overflow: TextOverflow.ellipsis))]),
                      if (store.phone.isNotEmpty) Row(children: [mi('call', size: 13, color: C.green), const SizedBox(width: 3), Text(store.phone, style: body(12.5, color: C.textSecondary), textDirection: TextDirection.ltr)]),
                    ])),
                  ]),
            ...
            const SizedBox(height: 12),
            Text(trf('رصيدك الآن {n} Wz', {'n': '$balance'}), style: body(13, color: C.textTertiary)),
            const SizedBox(height: 16),
