...
class _MapScreenState extends ConsumerState<MapScreen> with WidgetsBindingObserver {
                ...
                children: [
                  ...
                  if (_locationDenied) Positioned(top: 66, right: 16, left: 16, child: Container(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(child: Text(tr('فعّل الموقع لعرض أقرب نقاط الجمع وحساب المسافات'), style: body(12.5, color: const Color(0xFF8A6A1E)))),
          ...
          child: Padding(padding: const EdgeInsets.fromLTRB(20, 12, 20, 8), child: Column(children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Row(children: [
                ...
                Text(_locationGranted ? tr('الأقرب أولاً') : tr('كل النقاط'), style: body(13, color: C.textSecondary)),
                const SizedBox(width: 8),
                AnimatedRotation(
      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [mi('location_on', size: 14, color: C.textTertiary), const SizedBox(width: 4), Expanded(child: Text(p.address, style: body(13, color: C.textSecondary), overflow: TextOverflow.ellipsis))]),
            ...
            Row(children: [
              ...
              const SizedBox(width: 8),
              Text(p.hours, style: body(12.5, color: C.textTertiary)),
            ]),
          ])),
          const SizedBox(width: 8),
          Column(children: [
  ...
  void _showMapLegend() {
    ...
    Widget row(Color c, String icon, String text) => Padding(
      ...
      child: Row(children: [
        ...
        const SizedBox(width: 12),
        Expanded(child: Text(tr(text), style: body(14, color: C.textSecondary, height: 1.5))),
      ]),
    );
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          ...
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text(p.area, style: body(14, color: C.textSecondary)),
            ])),
            if (p.distanceLabel.isNotEmpty)
              Container(padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6), decoration: BoxDecoration(color: C.tint1, borderRadius: BorderRadius.circular(12)),
                child: Column(children: [Text(p.distanceLabel, style: cairo(15, w: FontWeight.w800, color: C.greenBtnEnd)), Text(tr('من موقعك'), style: body(11.5, color: const Color(0xFF6B7F73)))])),
          ]),
          ...
          if (p.address.trim().isNotEmpty) ...[
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(width: 8),
              Expanded(child: Text(p.address, style: body(14, color: C.textSecondary, height: 1.5))),
            ]),
          ],
          ...
          if (p.details.trim().isNotEmpty) ...[
            ...
            Container(
              ...
              child: Text(p.details, style: body(14, color: C.textSecondary, height: 1.6)),
            ),
          ],
          const SizedBox(height: 16),
          Row(children: [
          ...
          Container(
            ...
            child: Row(children: [
              ...
              const SizedBox(width: 10),
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(tr('رقم الهاتف'), style: body(12, color: C.textSecondary)),
            ...
            child: Container(
              ...
              child: Row(children: [
                ...
                Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(tr('افتح الملاحة خطوة بخطوة'), style: body(12, color: C.textTertiary)),
                ])),
  ...
  Widget _infoBox(String icon, String label, String value) => Container(
    ...
    child: Row(children: [
      ...
      const SizedBox(width: 8),
      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(tr(label), style: body(12, color: C.textSecondary)),
